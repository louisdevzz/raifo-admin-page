    ...
    return(
        <div className="h-[88vh] px-3">
            ...
            <div className="px-3 grid grid-cols-1 gap-5 md:grid-cols-2 py-2 mt-3 rounded-md h-[90vh] ">
                <div className="bg-white md:w-full lg:w-3/4 flex flex-col justify-between h-[88vh] overflow-y-scroll">
                    <div className="">
                        {isCreate == true &&(
                        ...
                        {select=="detainghiencuu"?(
                            ...
                            select&&select!="bieumau"?(
                                <div className="px-5 py-2">
                                    ...
                                    <div className="mt-2">
                                        <ReactQuill theme="snow" className="h-[35vh]" value={content} onChange={(newcontent)=>setContent(newcontent)} modules={modules} formats={formats} />
                                    </div>
                                </div>
                            ):(
                                select&&(
                ...
                <div className="w-full flex flex-col">
                    ...
                    <div className={`${select=="tintucsukien"?"w-11/12 h-[80vh]":"w-3/4 h-3/4"} bg-white px-5 py-5 overflow-y-auto`}>
