                    ...
                    <div>
                            ...
                            (
                                <div className="px-5 py-2">
                                    <div className="py-2">
                                        ...
                                        <textarea onChange={(e)=>setWriter(e.target.value)} className="h-20 px-3 text-sm py-1 mt-2 outline-none border-gray-300 w-full resize-none border rounded-lg placeholder:text-sm"/>
                                    </div>
                        ...
                        {select=="detainghiencuu"?(
                            ...
                            <div className="mt-2 px-5 py-2">
                                ...
                                <textarea onChange={(e)=>setContent(e.target.value)} className="h-40 overflow-auto px-3 text-sm py-1 mt-2 outline-none border-gray-300 w-full resize-none border rounded-lg placeholder:text-sm"/>  
                            </div>
                        )}
                        {select!="tintucsukien"&&(
                            <div className="mt-2 px-5 py-2">
