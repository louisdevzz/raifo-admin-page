                            ...
                            <div>
                                ...
                                <div className="w-44 z-50 absolute right-0 hidden group-hover:block transition-[margin,opacity] duration-300 shadow-lg border rounded py-2 border-gray-200">
                                    <a className="flex items-center py-2 px-5 text-sm text-gray-800 " href="pages-gallery.html">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" data-lucide="user" className="lucide lucide-user w-4 h-4 me-2"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                    ...
                                    <a className="flex items-center py-2 px-5 text-sm text-gray-800" href="auth-login.html">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" data-lucide="log-out" className="lucide lucide-log-out w-4 h-4 me-2"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" x2="9" y1="12" y2="12"></line></svg>
                                        <span>Đăng xuất</span>
                                    </a>
                                </div>
                            </div>
